...
if ($search !== '') {
    // use stored proc Category_Search
    while ($con->more_results()) {
        $con->next_result();
    ...
    // simple count and paginate with direct SELECT
                        ...
                        <?php else: foreach ($rows as $i => $c): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php elseif (strtolower($c['status']) === 'deleted'): ?>
                                ...
                                <td>
                                    <div class="d-flex flex-wrap gap-2">
                                        ...
                                        <!-- View Modal -->
                                        <div class="modal fade" id="viewCategoryModal<?= (int)$c['id'] ?>" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header" style="background:#0d9488; color:white;">
                                                        <h5 class="modal-title"><i class="fa fa-tags me-2"></i> Category Details</h5>
                                        ...
                                        <!-- Edit Modal -->
                                        <div class="modal fade" id="editCategoryModal<?= (int)$c['id'] ?>" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <form method="POST" action="admin_categories.php">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input name="category_name" class="form-control" value="<?= htmlspecialchars($c['category_name']) ?>" data-validation="required">
                                                                <span class="error text-danger" id="categoryNameError<?= (int)$c['id'] ?>"></span>
                                                            </div>
                                                            <div class="mb-3">
                                                                ...
                                                                <span class="error text-danger" id="statusError<?= (int)$c['id'] ?>"></span>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="submit" name="update_category" class="btn text-white fw-semibold" style="background:#0d9488;">
                                        ...
                                        <!-- Delete Form -->
                                        <?php if (strtolower($c['status']) === 'active'): ?>
                                            <!-- Deactivate: use your existing delete_category handler (soft delete) -->
                                            <form method="POST" action="admin_categories.php"
                                        ...
                                        <?php else: ?>
                                            <!-- Activate: reuse update_category handler by posting status=Active and id -->
                                            <form method="POST" action="admin_categories.php"
                                                style="display:inline-block"
                                                onsubmit="return confirm('Activate this category?');">
                                                <input type="hidden" name="id" value="<?= (int)$c['id'] ?>">
                                                <input type="hidden" name="category_name" value="<?= htmlspecialchars($c['category_name'], ENT_QUOTES) ?>">
                                                <input type="hidden" name="status" value="Active">
                                                <button type="submit" name="update_category" class="btn btn-sm btn-outline-success">
        ...
        <div class="modal-content">
            <form method="POST" action="admin_categories.php">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label class="form-label">Category Name</label>
                        <input name="category_name" class="form-control" data-validation="required">
